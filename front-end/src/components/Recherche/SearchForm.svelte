...
<div class="search-form fontSecondary">
  ...
  <div class="input-container container3">
      ...
      <input bind:this={input3} class="custom-placeholder input3" type="date" bind:value={date} data-placeholder="jj/mm/aaaa"
  ...
  <div class="input-container container5">
    ...
    <input bind:this={input5} class="custom-placeholder input5" type="text" bind:value={critères} data-placeholder="pick from the list"
  ...
  <!-- <div class="input-container container5">
    ...
    <input bind:this={input5} class="custom-placeholder input5" type="text" bind:value={critères} data-placeholder="pick from the list"
    on:focus={() => { isFocused5 = true; togglePanel(); }} on:blur={() => onBlur(value => isFocused5 = value)} />
    
    <TagPanel {tags} visible={showPanel} />
    {#if critères && isFocused5}
    <button class="clear-button" on:click={() => clearInput(input5, value => critères = value)}>
      <lord-icon
          class="animated-cross"
          src="https://cdn.lordicon.com/zxvuvcnc.json"
